...
struct TRAJECTORY_REPRESENTATION_BEZIER : mavlink::Message {
    ...
    std::array<float, 5> pos_x; /*< X-coordinate of starting bezier point, set to NaN if not being used */
    std::array<float, 5> pos_y; /*< Y-coordinate of starting bezier point, set to NaN if not being used */
    std::array<float, 5> pos_z; /*< Z-coordinate of starting bezier point, set to NaN if not being used */
    std::array<float, 5> delta; /*< Bezier time horizon, set to NaN if velocity/acceleration should not be incorporated */
    std::array<float, 5> pos_yaw; /*< Yaw, set to NaN for unchanged */
