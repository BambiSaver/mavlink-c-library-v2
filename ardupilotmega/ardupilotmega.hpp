...
enum class MAV_CMD
{
    ...
    BAMBI_START_STOP_MISSION=2720, /* Request to start/stop Bambi mission |Trigger Mission (0: stop, 1: start)| Empty| Empty| Empty| Empty| Empty| Empty|  */
